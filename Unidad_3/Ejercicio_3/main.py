...
if __name__=='__main__':
    ...
    GE.cargarEmpleados()
    GP.cargarProgramas()
    GM.asignarMatriculaciones(GE,GP)
    #print("----Lista de Matriculas----")
    #GM.listarMatriculas()
    #print("----Lista de IDs de Matriculas en el Gestor----")
    #GM.mostrarIDSMatriculas()
    #print("----\nLista de IDs de Matriculas en Empleados----")
    #GE.mostrarIDSmatriculas()
    #print("----\nLista de IDs de Matriculas en Programas----")
    #GP.mostrarIDSmatriculas()
    opcion=menu()
    while opcion!=0:
        if opcion==1:
            try:
            ...
            GM.borrarMatriculaPorIndice(2) #Le puse el indice 2 para probar
            GM.listarMatriculas()
        else:
